...
#define OPENSHOT_VERSION_ALL "0.2.3"        /// A string of the entire version "Major.Minor.Build"
#define OPENSHOT_VERSION_FULL "0.2.3-dev1"   /// A string of the full version identifier, including suffixes (e.g. "0.0.0-dev0")
